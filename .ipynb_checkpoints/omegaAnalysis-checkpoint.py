...
print('initialMass -- apogeeAlt: ')
print(z.at['SCUDB.MassProperties.initialMass', 'apogeeTime'])
...
print('targetAltitude -- apogeeAlt: ')
print(z.at['SCUDB.targetAltitude', 'apogeeTime'])
...
print('targetRange -- apogeeAlt: ')
print(z.at['SCUDB.targetRange', 'apogeeTime'])
'''
sns.heatmap(z, cmap='viridis', annot=True)
plt.show()
...
z3 = feature_scoring.F_REGRESSION(X=data, y=outcomes['impact'])
print(z3)
